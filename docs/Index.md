...
- [../NOTES.md](../NOTES.md) — placeholder data, flagged assumptions and decisions pending client/real-world input
- [Open Questions](./OpenQuestions.md) — decisions that need a person (client/teammate), not code
